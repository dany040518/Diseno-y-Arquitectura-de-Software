...
public class Game extends Canvas implements Runnable {
	...
	public void init(StyleFactory f){
		...
		player = StyleFactory.createPlayerRenderer(
                    (WIDTH * SCALE - PlayerRenderer.WIDTH) / 2,
                    HEIGHT * SCALE - 50,
                    this
                );
		...
		backgRenderer=StyleFactory.createBackgroundRenderer(this);
	}
	...
	public static void main(String args[]){	
		...
		frame.setVisible(true);
            String style = "vector"; // O "sprite"
    
            if (style.equals("sprite")) {
                f = new SpritesStyleFactory();
                game.cargarSprites();
            } else if(style.equals("vector")){
                f = new VectorStyleFactory();
            }else{
                f = new ColorfulVectorStyleFactory();
            }
                game.init(f);
		game.start();
	}
